...
from src.mdev.generative.shorn import CSHORN, SHORNValidatorWrapper
...
if __name__ == '__main__':
    ...
    recipe = CSHORN.ModelRecipe.from_file(fp_recipe)
    ...
    model = CSHORN(
        ...
        model_recipe=recipe,
        training_controls=CSHORN.TrainingControls(
            autosave_period=100,
    ...
    val_wrapper = SHORNValidatorWrapper(model, dev_ds_validate)
    loss_plotter = TrainingProgressPlotter(model, validators=[val_wrapper.validator])
    ...
    model.event_handler.subscribe(event_10_epochs, val_wrapper.g_validator.calculate_validation_loss)
